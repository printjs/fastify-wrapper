...
function preSerializationWidget(...fns) {
    return function (target, propertyKey, descriptor) {
        reflect_1.defineMetadata(widget_key_1.WidgetKey.PreSerialization, new process_model_1.ProcessModel({
...
exports.preSerializationWidget = preSerializationWidget;
